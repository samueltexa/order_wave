      ...
      content: const SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
                "By accessing or using the OrderWave mobile application (\"App\") provided by \"SamuelTech\" Company, you agree to comply with and be bound by these Terms of Use. If you do not agree to these terms, please do not use the App.",
